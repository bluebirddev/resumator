    ...
    workExperience: [
        {
            ...
            bulletPoints: [
                <>Founded a small company of remote developers with the mission of becoming the most sought-after tech company to work for.  <em>(bluebird.dev)</em></>,
                <>Built and maintained a logistics system for Raubex – South Africa's biggest construction company.</>,
                <>Led the creation of Revix's new website <em>(revix.com)</em>. Improved the Lighthouse performance score from 22 to 90+.</>,
                <>Built KZN South Coast Explorer (available on the app stores) for December 2019’s vacation rush in 3 weeks.</>,
        ...
        },
        {
            ...
            company: '22seven',
            bulletPoints: ['Led 22seven’s web development, which included the migration of the web application (with a user base of 200k+) from Angular to React.'],
            dates: 'Oct 2017 – Sep 2018'
        },
        {
            title: 'Senior Developer',
            company: 'BlazingChilli',
            bulletPoints: ['Introduced, developed, and maintained a centralized web console to holistically manage the company’s internal systems, which is used by the support personnel, the developers, and the managers.'],
